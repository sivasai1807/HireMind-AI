      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
        <div>
          ...
          <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] flex items-center gap-2">
            ...
            Analyzing session: {activeInterview?.jobRole || 'Global Intelligence'}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="lg:col-span-2 glass p-8 rounded-[2.5rem] flex items-center justify-between border-indigo-500/10">
              <div>
                <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Resume Authority</h4>
                <div className="text-6xl font-black text-white tabular-nums">
                  {activeResume?.ats_score || 0}<span className="text-xl opacity-30 ml-1">%</span>
                </div>
              </div>
              <div className="hidden sm:block">
                 ...
                 <p className="text-[9px] text-right font-bold text-indigo-400 mt-2">ATS Ranking Optima</p>
              </div>
            </div>
            ...
            <div className="glass p-8 rounded-[2.5rem] border-emerald-500/10 relative overflow-hidden group">
               ...
               <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Neural Avg.</h4>
          ...
          <div className="glass rounded-[2.5rem] p-10 space-y-12">
             <div className="flex items-center justify-between">
                <h2 className="text-2xl font-black text-white tracking-tight flex items-center gap-3">
                  <i className="fas fa-bolt-lightning text-amber-400"></i> Performance Breakdown
                </h2>
                {activeInterview && (
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                      <div className="space-y-6">
                         <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500 flex items-center gap-2">
                           <i className="fas fa-check-circle"></i> Dominant Skills
                         </h4>
                      ...
                      <div className="space-y-6">
                         <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-rose-500 flex items-center gap-2">
                           <i className="fas fa-triangle-exclamation"></i> Growth Points
                         </h4>
                         <div className="space-y-3">
                   ...
                   <div className="pt-6 border-t border-white/5">
                      <div className="p-8 rounded-3xl bg-indigo-600/5 border border-indigo-500/10 flex flex-col md:flex-row items-center justify-between gap-6">
                         <div className="text-center md:text-left">
                            <h5 className="font-bold text-white mb-1">Strategic Learning Roadmap</h5>
                            <p className="text-xs text-slate-500">Based on your weaknesses, we've optimized a 30-day plan.</p>
                         </div>
                         <button onClick={onGenerateRoadmap} className="px-6 py-3 bg-white/5 hover:bg-white/10 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all">View Roadmap</button>
                      </div>
                   </div>
                </div>
             )}
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="glass rounded-[2.5rem] p-8 h-full min-h-[600px] flex flex-col">
              <div className="mb-8">
                 <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-6">Neural Archive</h3>
              ...
              <div className="flex-grow overflow-y-auto space-y-8 pr-2 scrollbar-thin">
                 ...
                 <div className="space-y-4">
                    <h5 className="text-[9px] font-black uppercase tracking-widest text-indigo-400/60 px-2">Resumes</h5>
                    {filteredResumeHistory.map(res => (
                       <div key={res.id} onClick={() => onSelectResume(res)} className={`group relative p-5 rounded-3xl border-2 cursor-pointer transition-all ${activeResume?.id === res.id ? 'bg-indigo-600/10 border-indigo-500/40 shadow-xl' : 'bg-black/20 border-white/5 hover:border-white/10'}`}>
                          <div className="flex justify-between items-start mb-1">
                             ...
                             <div className="text-[10px] font-black text-indigo-400">{res.ats_score}%</div>
                          </div>
